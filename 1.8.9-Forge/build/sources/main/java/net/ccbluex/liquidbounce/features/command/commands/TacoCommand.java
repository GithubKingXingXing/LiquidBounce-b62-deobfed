...
public class TacoCommand extends Command implements EventListener
{
    ...
    public void onRender2D(final Render2DEvent event) {
        ...
        RenderUtils.drawImage(this.tacoTextures[this.image], this.running, scaledResolution.getScaledHeight() - 60, 64, 32);
        if (scaledResolution.getScaledWidth() <= this.running) {
            this.running = -64;
        }
    }
