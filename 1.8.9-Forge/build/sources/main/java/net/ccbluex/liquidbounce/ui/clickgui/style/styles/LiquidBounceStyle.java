...
public class LiquidBounceStyle implements Style
{
    ...
    public void drawDescription(final int mouseX, final int mouseY, final String text) {
        ...
        RenderUtils.drawBorderedRect((float)(mouseX + 9), (float)mouseY, (float)(mouseX + textWidth + 14), (float)(mouseY + Fonts.font35.FONT_HEIGHT + 3), 1.0f, new Color(255, 255, 255, 90).getRGB(), Integer.MIN_VALUE);
            ...
            if (moduleElement.isShowSettings()) {
                ...
                for (final Value value : moduleValues) {
                    if (value instanceof BoolValue) {
                        ...
                        GlStateManager.resetColor();
                        Fonts.font35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, value.asBoolean() ? guiColor : Integer.MAX_VALUE);
                        yPos += 12;
                    }
                        ...
                        RenderUtils.drawRect((float)(moduleElement.getX() + moduleElement.getWidth() + 4), (float)(yPos + 2), moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth(), (float)(yPos + 14), Integer.MIN_VALUE);
                        GlStateManager.resetColor();
                        Fonts.font35.drawString("§c" + text2, moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, 16777215);
                        Fonts.font35.drawString(listValue.open ? "-" : "+", (int)(moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() - (listValue.open ? 5 : 6)), yPos + 4, 16777215);
                        if (mouseX >= moduleElement.getX() + moduleElement.getWidth() + 4 && mouseX <= moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() && mouseY >= yPos + 2 && mouseY <= yPos + 14 && Mouse.isButtonDown(0) && moduleElement.isntPressed()) {
                        ...
                        for (final String valueOfList : listValue.getValues()) {
                            ...
                            if (listValue.open) {
                                ...
                                Fonts.font35.drawString(valueOfList, moduleElement.getX() + moduleElement.getWidth() + 14, yPos + 4, (listValue.asString() != null && listValue.asString().equalsIgnoreCase(valueOfList)) ? guiColor : Integer.MAX_VALUE);
                                yPos += 12;
                            }
                        }
                    }
                        ...
                        GlStateManager.resetColor();
                        Fonts.font35.drawString(text2, moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, 16777215);
                        yPos += 22;
                    }
