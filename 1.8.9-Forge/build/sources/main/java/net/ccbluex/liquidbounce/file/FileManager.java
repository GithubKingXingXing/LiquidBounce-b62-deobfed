...
public class FileManager
{
    ...
    public FileManager() {
        this.dir = new File(Minecraft.getMinecraft().mcDataDir, "LiquidBounce-1.8");
    ...
    public void loadBackground() {
        if (this.backgroundFile.exists()) {
            try {
                ...
                Minecraft.getMinecraft().getTextureManager().loadTexture(LiquidBounce.CLIENT.background, (ITextureObject)new DynamicTexture(bufferedImage));
