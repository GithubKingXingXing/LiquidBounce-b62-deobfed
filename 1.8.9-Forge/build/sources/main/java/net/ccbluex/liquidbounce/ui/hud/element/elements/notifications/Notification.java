...
public class Notification
{
    ...
    public void draw(final Notifications notifications) {
        ...
        this.textLength = Fonts.font35.getStringWidth(this.message);
        Gui.drawRect(location[0] - (int)this.x, location[1], location[0] - (int)this.x + 8 + this.textLength, location[1] - 20, Color.BLACK.getRGB());
        Gui.drawRect(location[0] - (int)this.x - 5, location[1], location[0] - (int)this.x, location[1] - 20, new Color(0, 160, 255).getRGB());
