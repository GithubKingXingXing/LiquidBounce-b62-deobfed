...
public class BlockESP extends Module
{
                ...
                if (args.length > 1) {
                    if (args[1].equalsIgnoreCase("select")) {
                        if (args.length > 2) {
                            ...
                            if (id != 0 && Block.getBlockById(id) != null && Block.getBlockById(id) != Blocks.air) {
                                BlockESP.this.blockValue.setValue(id);
                                this.chat("§7The block was set to " + BlockUtils.getBlockName(id) + ".");
                                BlockESP$1.mc.getSoundHandler().playSound((ISound)PositionedSoundRecord.create(new ResourceLocation("random.anvil_use"), 1.0f));
                            }
                            else {
                        ...
                        this.chat("§7Current: §8" + Block.getBlockById(BlockESP.this.blockValue.asInteger()).getLocalizedName());
    ...
    public void onUpdate(final UpdateEvent event) {
        ...
        //    45: invokestatic    net/minecraft/block/Block.getBlockById:(I)Lnet/minecraft/block/Block;
        //    48: astore_3        /* selectedBlock */
        //    49: aload_3         /* selectedBlock */
        //    50: ifnull          60
        //    53: aload_3         /* selectedBlock */
        //    54: getstatic       net/minecraft/init/Blocks.air:Lnet/minecraft/block/Block;
        //    57: if_acmpne       61
        //    60: return         
        //    61: aload_0         /* this */
