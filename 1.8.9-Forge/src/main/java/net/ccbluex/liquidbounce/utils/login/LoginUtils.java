...
public final class LoginUtils
{
    public static LoginResult login(final String username, final String password) {
        ...
        try {
            ...
            Minecraft.getMinecraft().session = new Session(userAuthentication.getSelectedProfile().getName(), userAuthentication.getSelectedProfile().getId().toString(), userAuthentication.getAuthenticatedToken(), "mojang");
    ...
    public static void loginCracked(final String username) {
        Minecraft.getMinecraft().session = new Session(username, UniversallyUniqueIdentifierUtils.INSTANCE.getUUID(username), "-", "legacy");
    }
