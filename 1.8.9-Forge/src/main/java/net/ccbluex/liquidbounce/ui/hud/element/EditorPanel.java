...
public class EditorPanel
{
    ...
    public void drawPanel(final int mouseX, int mouseY, final int wheel) {
        ...
        Gui.drawRect(this.x, this.y + 12, this.x + this.width, this.y + this.realHeight, new Color(27, 34, 40).getRGB());
        if (this.hudDesigner.selectedElement != null) {
            this.height = this.scroll + 15;
            this.realHeight = 15;
            this.width = 80;
            Fonts.font35.drawString("X: " + this.hudDesigner.selectedElement.getLocationFromFacing()[0] + " (" + this.hudDesigner.selectedElement.getX() + ")", this.x + 2, this.y + this.height, Color.WHITE.getRGB());
            this.height += 10;
            this.realHeight += 10;
            Fonts.font35.drawString("Y: " + this.hudDesigner.selectedElement.getLocationFromFacing()[1] + " (" + this.hudDesigner.selectedElement.getY() + ")", this.x + 2, this.y + this.height, Color.WHITE.getRGB());
            this.height += 10;
            this.realHeight += 10;
            BigDecimal bd = new BigDecimal(Float.toString(this.hudDesigner.selectedElement.getScale()));
            bd = bd.setScale(2, 4);
            Fonts.font35.drawString("Scale: " + bd.toString(), this.x + 2, this.y + this.height, Color.WHITE.getRGB());
            this.height += 10;
            this.realHeight += 10;
            Fonts.font35.drawString("H:", this.x + 2, this.y + this.height, Color.WHITE.getRGB());
            Fonts.font35.drawString(this.hudDesigner.selectedElement.getFacing().getHorizontal().getName(), this.x + 12, this.y + this.height, Color.GRAY.getRGB());
            ...
            Fonts.font35.drawString(this.hudDesigner.selectedElement.getFacing().getVertical().getName(), this.x + 12, this.y + this.height, Color.GRAY.getRGB());
            this.height += 10;
            this.realHeight += 10;
            this.width = 100;
                ...
                try {
                    ...
                    if (o instanceof Value) {
                        ...
                        if (value instanceof BoolValue) {
                            ...
                            Fonts.font35.drawString(value.getValueName(), this.x + 2, this.y + this.height, boolValue.asBoolean() ? Color.WHITE.getRGB() : Color.GRAY.getRGB());
                            final int stringWidth = Fonts.font35.getStringWidth(value.getValueName());
                        ...
                        if (o instanceof FloatValue) {
                            ...
                            Fonts.font35.drawString(value.getValueName() + ": §c" + floatBigDecimal.toString(), this.x + 2, this.y + this.height, Color.WHITE.getRGB());
                            final int stringWidth2 = Fonts.font35.getStringWidth(value.getValueName() + ": §c" + valueNumber);
                            ...
                            if (mouseX >= this.x + 8 && mouseX <= this.x + this.width && mouseY >= this.y + this.height + 9 && mouseY <= this.y + this.height + 15 && Mouse.isButtonDown(0)) {
                                final float j = MathHelper.clamp_float((mouseX - this.x - 8) / (float)(this.width - 12), 0.0f, 1.0f);
                        ...
                        if (o instanceof IntegerValue) {
                            ...
                            Fonts.font35.drawString(value.getValueName() + ": §c" + valueNumber2, this.x + 2, this.y + this.height, Color.WHITE.getRGB());
                            ...
                            final int stringWidth2 = Fonts.font35.getStringWidth(value.getValueName() + ": §c" + integerBigDecimal.toString());
                            if (this.width < stringWidth2 + 8) {
                                this.width = stringWidth2 + 8;
                            }
                            ...
                            RenderUtils.drawRect(8.0f + sliderValue, (float)(this.y + this.height + 9), sliderValue + 11.0f, (float)(this.y + this.height + 15), new Color(37, 126, 255).getRGB());
                            if (mouseX >= this.x + 8 && mouseX <= this.x + this.width && mouseY >= this.y + this.height + 9 && mouseY <= this.y + this.height + 15 && Mouse.isButtonDown(0)) {
                                final float j = MathHelper.clamp_float((mouseX - this.x - 8) / (float)(this.width - 18), 0.0f, 1.0f);
                        ...
                        if (o instanceof ListValue) {
                            ...
                            Fonts.font35.drawString(value.getValueName(), this.x + 2, this.y + this.height, Color.WHITE.getRGB());
                            this.height += 10;
                            this.realHeight += 10;
                            for (final String s : listValue.getValues()) {
                                Fonts.font35.drawString("§c> §r" + s, this.x + 2, this.y + this.height, s.equals(listValue.asString()) ? Color.WHITE.getRGB() : Color.GRAY.getRGB());
                                final int stringWidth3 = Fonts.font35.getStringWidth("§c> §r" + s);
                    ...
                    if (o instanceof FontRenderer) {
                        ...
                        Fonts.font35.drawString(displayString, this.x + 2, this.y + this.height, Color.WHITE.getRGB());
            ...
            Gui.drawRect(this.x, this.y, this.x + this.width, this.y + 12, new Color(37, 126, 255).getRGB());
            ...
            for (final Element element : LiquidBounce.CLIENT.hud.getElements()) {
                Fonts.font35.drawString(NameIndex.getName(element.getClass()), this.x + 2, this.y + this.height, Color.WHITE.getRGB());
                final int stringWidth4 = Fonts.font35.getStringWidth(NameIndex.getName(element.getClass()));
        ...
        if (shouldScroll) {
            Gui.drawRect(this.x + this.width - 5, this.y + 15, this.x + this.width - 2, this.y + 197, new Color(41, 41, 41).getRGB());
