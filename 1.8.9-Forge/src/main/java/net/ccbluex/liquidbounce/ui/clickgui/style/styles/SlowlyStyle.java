...
public class SlowlyStyle implements Style
{
    ...
    public void drawPanel(final int mouseX, final int mouseY, final Panel panel) {
        ...
        final float textWidth = (float)Fonts.font35.getStringWidth("§f" + StringUtils.stripControlCodes(panel.getName()));
    ...
    public void drawDescription(final int mouseX, final int mouseY, final String text) {
        ...
        RenderUtils.drawBorderedRect((float)(mouseX + 9), (float)mouseY, (float)(mouseX + textWidth + 14), (float)(mouseY + Fonts.font35.FONT_HEIGHT + 3), 3.0f, new Color(42, 57, 79).getRGB(), new Color(42, 57, 79).getRGB());
        GlStateManager.resetColor();
            ...
            if (moduleElement.isShowSettings()) {
                ...
                for (final Value value : moduleValues) {
                    if (value instanceof BoolValue) {
                        ...
                        final float textWidth = (float)Fonts.font35.getStringWidth(text);
                        ...
                        Fonts.font35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, value.asBoolean() ? Color.WHITE.getRGB() : Integer.MAX_VALUE);
                        moduleElement.slowlySettingsYPos += 11;
                    }
                    else if (value instanceof ListValue) {
                        final ListValue listValue = (ListValue)value;
                        final String text2 = value.getValueName();
                        final float textWidth2 = (float)Fonts.font35.getStringWidth(text2);
                        if (moduleElement.getSettingsWidth() < textWidth2 + 16.0f) {
                            moduleElement.setSettingsWidth(textWidth2 + 16.0f);
                        }
                        Fonts.font35.drawString(text2, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, 16777215);
                        Fonts.font35.drawString(listValue.open ? "-" : "+", (int)(moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() - (listValue.open ? 5 : 6)), moduleElement.slowlySettingsYPos + 2, 16777215);
                        ...
                        for (final String valueOfList : listValue.getValues()) {
                            final float textWidth3 = (float)Fonts.font35.getStringWidth("> " + valueOfList);
                            ...
                            if (listValue.open) {
                                ...
                                GlStateManager.resetColor();
                                Fonts.font35.drawString("> " + valueOfList, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, (listValue.asString() != null && listValue.asString().equalsIgnoreCase(valueOfList)) ? Color.WHITE.getRGB() : Integer.MAX_VALUE);
                                moduleElement.slowlySettingsYPos += Fonts.font35.FONT_HEIGHT + 1;
                            }
                        }
                        if (listValue.open) {
                        ...
                        Fonts.font35.drawString(text2, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 3, 16777215);
