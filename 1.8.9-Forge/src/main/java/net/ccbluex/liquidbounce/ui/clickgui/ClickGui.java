...
public class ClickGui extends GuiScreen
{
                ...
                this.getElements().add(new ButtonElement("Players") {
                    ...
                    public void mouseClicked(final int mouseX, final int mouseY, final int mouseButton) {
                        if (mouseButton == 0 && this.isHovering(mouseX, mouseY) && this.isVisible()) {
                            ...
                            this.displayName = "Players";
                            this.color = (EntityUtils.targetPlayer ? ClickGUI.generateColor().getRGB() : Integer.MAX_VALUE);
                            ClickGui.this.mc.getSoundHandler().playSound((ISound)PositionedSoundRecord.create(new ResourceLocation("gui.button.press"), 1.0f));
                        }
                    }
                });
    ...
    public void drawScreen(int mouseX, int mouseY, final float partialTicks) {
        if (Mouse.isButtonDown(0) && mouseX >= 5 && mouseX <= 50 && mouseY <= this.height - 5 && mouseY >= this.height - 50) {
            this.mc.displayGuiScreen((GuiScreen)new GuiHudDesigner());
        }
        ...
        RenderUtils.drawFilledCircle(25, this.height - 25, 16.0f, new Color(37, 126, 255));
        RenderUtils.drawImage(this.hudIcon, 12, this.height - 35, 23, 23);
