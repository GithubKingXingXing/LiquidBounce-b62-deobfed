...
public class Trigger extends Module
{
                        ...
                        if (args.length > 2) {
                            try {
                                ...
                                if (value <= 20) {
                                    ...
                                    Trigger$3.mc.getSoundHandler().playSound((ISound)PositionedSoundRecord.create(new ResourceLocation("random.anvil_use"), 1.0f));
                                }
                                else {
    ...
    public void onUpdate(final UpdateEvent event) {
        if (Trigger.mc.objectMouseOver != null && System.currentTimeMillis() - this.lastSwing >= this.delay && EntityUtils.isSelected(Trigger.mc.objectMouseOver.entityHit, true)) {
            Trigger.mc.clickMouse();
