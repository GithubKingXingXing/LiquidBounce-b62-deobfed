...
public class RazerKeyboard extends Module
{
    ...
    private void updateKeyboard() {
        if (RazerKeyboard.mc.thePlayer != null && RazerKeyboard.mc.theWorld != null) {
            ...
            if (this.healthValue.asBoolean()) {
                final double health = RazerKeyboard.mc.thePlayer.getHealth() / RazerKeyboard.mc.thePlayer.getMaxHealth();
