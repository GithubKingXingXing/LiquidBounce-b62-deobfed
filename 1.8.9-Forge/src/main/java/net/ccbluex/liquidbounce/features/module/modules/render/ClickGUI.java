...
public class ClickGUI extends Module
{
                ...
                if (args.length > 1) {
                    if (args[1].equalsIgnoreCase("style")) {
                        if (args.length > 2 && ClickGUI.this.styleValue.contains(args[2])) {
                            ...
                            ClickGUI$2.mc.getSoundHandler().playSound((ISound)PositionedSoundRecord.create(new ResourceLocation("random.anvil_use"), 1.0f));
                            return;
                        }
    ...
    public void onEnable() {
        this.updateStyle();
        ClickGUI.mc.displayGuiScreen((GuiScreen)LiquidBounce.CLIENT.clickGui);
    }
